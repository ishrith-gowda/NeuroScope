...
class LaTeXReporter:
    ...
    def __init__(self, decimal_places: int = 4, bold_best: bool = True, include_std: bool = True):
        """
        args:
    ...
    def format_value(self, value: float, std: Optional[float] = None, is_best: bool = False) -> str:
