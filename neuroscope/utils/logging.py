...
class ExperimentLogger:
    ...
    def __init__(
        ...
        self.logger = setup_logger(
            name=experiment_name, log_file=self.output_dir / "experiment.log"
        )
        ...
        if use_wandb:
            try:
                ...
                self.wandb_run = wandb.init(
                    project="neuroscope", name=experiment_name, config=config
                )
            except ImportError:
    ...
    def save_artifact(self, data: Any, filename: str, artifact_type: str = "general"):
        """save artifact."""
