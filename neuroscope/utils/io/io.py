...
def save_nifti(data: np.ndarray, path: Union[str, Path], affine: np.ndarray = None):
    """
...
def save_checkpoint(
    ...
    **kwargs,
    ...
    checkpoint = {"epoch": epoch, "step": step, "metrics": metrics or {}, "config": config or {}}
...
def get_latest_checkpoint(
    checkpoint_dir: Union[str, Path], pattern: str = "checkpoint_epoch_*.pth"
) -> Optional[Path]:
    """
