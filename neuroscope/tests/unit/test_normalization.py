...
class TestVolumeNormalization:
    ...
    def test_min_max_normalization_custom_range(self):
        ...
        normalized = VolumeNormalization.min_max_normalization(volume, target_range=target_range)
...
class TestVolumePreprocessor:
    ...
    def test_preprocess_pipeline(self):
        ...
        preprocessor = VolumePreprocessor([("min_max_normalization", {"target_range": (0, 1)})])
...
class TestIntegration:
    ...
    def test_augmentation_pipeline(self):
        ...
        augmented = DataAugmentation.random_intensity_shift(augmented, shift_range=(0.1, 0.2))
        augmented = DataAugmentation.random_intensity_scale(augmented, scale_range=(0.8, 1.2))
