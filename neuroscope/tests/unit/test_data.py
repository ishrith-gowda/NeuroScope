...
class TestTransforms:
    ...
    def test_intensity_augmentation(self):
        ...
        transform = IntensityAugmentation(brightness_range=(-0.1, 0.1), contrast_range=(0.9, 1.1))
...
class TestDatasets:
    ...
    def test_dataset_length(self, mock_data_dir):
        ...
        dataset = MRIDataset(root_dir=str(mock_data_dir), modalities=["t1", "t1ce", "t2", "flair"])
    ...
    def test_paired_dataset(self, mock_data_dir):
        ...
        dataset = UnpairedMRIDataset(source_dir=str(mock_data_dir), target_dir=str(mock_data_dir))
...
class TestSamplers:
    ...
    def test_balanced_sampler(self):
        ...
        sampler = BalancedBatchSampler(
            source_indices=source_indices, target_indices=target_indices, batch_size=4
        )
