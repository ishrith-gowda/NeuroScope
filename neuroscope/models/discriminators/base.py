...
class BaseDiscriminator(nn.Module, ABC):
    ...
    def __init__(self, in_channels: int, ndf: int = 64, **kwargs):
        """
...
class MultiScaleDiscriminatorBase(BaseDiscriminator):
    ...
    def __init__(self, in_channels: int, ndf: int = 64, n_scales: int = 3, **kwargs):
        super().__init__(in_channels, ndf, **kwargs)
...
class ConditionalDiscriminator(BaseDiscriminator):
    ...
    def __init__(self, in_channels: int, ndf: int = 64, condition_channels: int = 0, **kwargs):
        super().__init__(in_channels, ndf, **kwargs)
...
class ProjectionDiscriminator(BaseDiscriminator):
    ...
    def __init__(self, in_channels: int, ndf: int = 64, n_classes: int = 0, **kwargs):
        super().__init__(in_channels, ndf, **kwargs)
...
class FeatureMatchingDiscriminator(BaseDiscriminator):
    ...
    def __init__(self, in_channels: int, ndf: int = 64, n_layers: int = 3, **kwargs):
        super().__init__(in_channels, ndf, **kwargs)
