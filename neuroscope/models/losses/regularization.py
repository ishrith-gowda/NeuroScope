...
class GradientPenalty(nn.Module):
    ...
    def forward(
        self, discriminator: nn.Module, real: torch.Tensor, fake: torch.Tensor
    ) -> torch.Tensor:
        """
...
class R1Regularization(nn.Module):
    ...
    def forward(self, discriminator: nn.Module, real: torch.Tensor) -> torch.Tensor:
...
class LatentRegularization(nn.Module):
    ...
    def forward(self, mu: torch.Tensor, logvar: Optional[torch.Tensor] = None) -> torch.Tensor:
        """
