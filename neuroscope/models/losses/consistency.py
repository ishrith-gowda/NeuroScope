...
class FeatureMatchingLoss(nn.Module):
    ...
    def forward(self, fake_features: list, real_features: list) -> torch.Tensor:
        """
...
class SemanticConsistencyLoss(nn.Module):
    ...
    def __init__(self, feature_extractor: nn.Module, layers: Optional[list] = None):
        super().__init__()
    ...
    def forward(self, input_img: torch.Tensor, output_img: torch.Tensor) -> torch.Tensor:
...
class ModeSeekingLoss(nn.Module):
    ...
    def forward(
        self, z1: torch.Tensor, z2: torch.Tensor, output1: torch.Tensor, output2: torch.Tensor
    ) -> torch.Tensor:
        """
