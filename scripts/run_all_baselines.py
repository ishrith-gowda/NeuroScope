...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run all baseline harmonization methods")
    ...
    parser.add_argument(
        "--output-dir", type=str, required=True, help="Output directory for experiments"
    )
