...
def generate_loss_curves_figure(history):
    ...
    ax.plot(
        epochs, cycle_loss_smooth, color=color_cycle, linewidth=2.2, label="Cycle Consistency Loss"
    )
    ax.set_xlabel("Epoch", fontsize=13)
    ax.set_ylabel("Loss", fontsize=13)
    ...
    ax.plot(
        epochs, identity_loss_smooth, color=color_identity, linewidth=2.2, label="Identity Loss"
    )
    ax.set_xlabel("Epoch", fontsize=13)
    ax.set_ylabel("Loss", fontsize=13)
...
def generate_validation_metrics_figure(history):
    ...
    ax.plot(
        ...
        linewidth=2.2,
        color=color_a2b,
        label=r"BraTS $\rightarrow$ UPenn",
    )
    ...
    ax.plot(
        ...
        linewidth=2.2,
        color=color_b2a,
        label=r"UPenn $\rightarrow$ BraTS",
    )
    ax.set_xlabel("Epoch", fontsize=13)
...
def generate_combined_losses_figure(history):
    ...
    ax.plot(
        ...
        identity_loss,
        linewidth=2.2,
        label=r"Identity Loss ($\lambda=5$)",
...
def generate_gradient_norms_figure(history):
    ...
    ax.plot(
        ...
        grad_g,
        linewidth=2.2,
        label="Generator Gradient",
        color=color_gen_grad,
        marker="o",
        markersize=1.5,
        alpha=0.8,
    )
    ax.plot(
        ...
        grad_d,
        linewidth=2.2,
        label="Discriminator Gradient",
        color=color_disc_grad,
        marker="s",
        markersize=1.5,
        alpha=0.8,
    )
