...
def create_feature_distribution_figure(results: dict, output_path: Path):
    ...
    if harmonized:
        ...
        bars = ax.bar(x, reductions, width * 1.5, color=colors, edgecolor="black", linewidth=0.5)
    ...
    # main figure title
    fig.suptitle(
        r"\textbf{Feature Distribution Analysis: Raw vs. Harmonized}",
        fontsize=18,
        fontweight="bold",
        y=0.96,
    )
...
def main():
    ...
    results_path = (
        ...
        / "feature_distribution_results.json"
    )
