...
class PublicationFigureGenerator:
    ...
    def plot_training_curves(self, history_file: Path, save_name: str = "training_curves"):
        """
...
def main():
    ...
    parser.add_argument(
        "--results", type=str, nargs="+", help="paths to evaluation results json files"
    )
    ...
    # create generator
    generator = PublicationFigureGenerator(output_dir=Path(args.output_dir), dpi=args.dpi)
