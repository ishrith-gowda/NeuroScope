...
def main():
    parser = argparse.ArgumentParser(description="run radiomics preservation analysis")
    parser.add_argument("--raw-a", type=str, required=True, help="path to raw domain a features")
    parser.add_argument("--raw-b", type=str, required=True, help="path to raw domain b features")
    parser.add_argument(
        "--harmonized-a", type=str, required=True, help="path to harmonized domain a features"
    )
    parser.add_argument(
        "--harmonized-b", type=str, help="path to harmonized domain b features (optional)"
    )
    ...
    results = run_preservation_analysis(
        raw_a, raw_b, harmonized_a, harmonized_b, feature_names, args.method_name
    )
    ...
    print(
        f"    excellent: {overall_a.get('excellent_preservation', 0)}, good: {overall_a.get('good_preservation', 0)}"
    )
