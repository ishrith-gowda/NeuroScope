...
def parse_args():
    ...
    parser.add_argument(
        "--output-dir", type=str, required=True, help="Output directory for corrected volumes"
    )
    ...
    parser.add_argument("--save-bias", action="store_true", help="Save estimated bias fields")
    parser.add_argument(
        "--shrink-factor", type=int, default=4, help="Shrink factor for downsampling"
    )
    parser.add_argument(
        "--iterations",
        type=int,
    ...
    parser.add_argument(
        "--convergence-threshold", type=float, default=0.001, help="Convergence threshold"
    )
    parser.add_argument(
        "--spline-order", type=int, default=3, help="Order of B-spline used in the approximation"
    )
    parser.add_argument(
        "--spline-distance",
        type=float,
    ...
    parser.add_argument("--output-json", type=str, help="Output JSON file for correction metrics")
