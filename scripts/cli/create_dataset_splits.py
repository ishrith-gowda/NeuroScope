...
def parse_args():
    ...
    parser.add_argument(
        "--domain-a-dir", type=str, required=True, help="Directory with domain A volumes"
    )
    parser.add_argument(
        "--domain-b-dir", type=str, required=True, help="Directory with domain B volumes"
    )
    parser.add_argument(
        "--output-dir", type=str, required=True, help="Output directory for split files"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--test-ratio", type=float, default=0.1, help="Fraction of data for testing"
    )
    parser.add_argument(
