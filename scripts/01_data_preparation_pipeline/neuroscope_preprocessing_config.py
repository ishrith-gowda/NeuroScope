...
def get_neuroscope_paths():
    ...
    paths = {
        ...
        "raw_brats_root": DATA_ROOT
        / "BraTS-TCGA-GBM"
        / "Pre-operative_TCGA_GBM_NIfTI_and_Segmentations",
        "raw_upenn_root": DATA_ROOT
        / "PKG - UPENN-GBM-NIfTI"
        / "UPENN-GBM"
        / "NIfTI-files"
        / "images_structural",
        ...
        # === metadata files ===
        "metadata_base": PROJECT_ROOT
        / "scripts"
        / "01_data_preparation_pipeline"
        / "neuroscope_dataset_metadata.json",
        "metadata_enriched": PROJECT_ROOT
        / "scripts"
        / "01_data_preparation_pipeline"
        / "neuroscope_dataset_metadata_enriched.json",
        "metadata_splits": PROJECT_ROOT
        / "scripts"
        / "01_data_preparation_pipeline"
        / "neuroscope_dataset_metadata_splits.json",
        "bias_assessment": PROJECT_ROOT
        / "scripts"
        / "01_data_preparation_pipeline"
        / "neuroscope_bias_assessment.json",
        "slice_bias_assessment": PROJECT_ROOT
        / "scripts"
        / "01_data_preparation_pipeline"
        / "neuroscope_slice_bias_assessment.json",
        "preprocessing_report": PROJECT_ROOT
        / "scripts"
        / "01_data_preparation_pipeline"
        / "preprocessing_verification_report_v2.json",
        # === split files ===
        "train_subjects_txt": PROJECT_ROOT
        / "scripts"
        / "01_data_preparation_pipeline"
        / "train_subjects.txt",
        "val_subjects_txt": PROJECT_ROOT
        / "scripts"
        / "01_data_preparation_pipeline"
        / "val_subjects.txt",
        "test_subjects_txt": PROJECT_ROOT
        / "scripts"
        / "01_data_preparation_pipeline"
        / "test_subjects.txt",
        # === templates ===
        "mni_template": PROJECT_ROOT
        / "scripts"
        / "01_data_preparation_pipeline"
        / "templates"
