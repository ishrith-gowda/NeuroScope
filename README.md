...
code style follows black formatter conventions with line length of 88 characters.
...
```
@article{gowda2023neuroscope,
  title={NeuroScope: Unsupervised Domain Adaptation for Multi-institutional Glioblastoma MRI Standardization},
  author={Gowda, Ishrith and et al.},
  journal={Computational Brain Imaging},
  volume={1},
  number={2},
  pages={100--115},
  year={2023}
...
this work was supported in part by grants from the national institutes of health (r01-eb029362, r01-ns042645). we thank the cancer imaging archive (tcia) for providing access to the brats-tcga dataset.
